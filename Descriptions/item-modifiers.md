...
| Ethereal (Cannot be Repaired) | Бесплотный предмет (нельзя ремонтировать) | Эфемерный предмет (нельзя ремонтировать) |
| Physical Damage Received Reduced by %d%% | Урон уменьшен на %d%% | Получаемый физический урон уменьшен на %d%% |
| Ethereal (Cannot be Repaired), Socketed (%i) | Бесплотный предмет (нельзя ремонтировать), с гнездами (%i) | Эфемерный предмет (нельзя ремонтировать), с гнездами (%i) |
