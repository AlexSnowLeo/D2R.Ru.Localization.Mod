...
| Ethereal (Cannot be Repaired) | Бесплотный предмет (нельзя ремонтировать) | Эфирный предмет (нельзя ремонтировать) |
| Ethereal (Cannot be Repaired), Socketed (%i) | Бесплотный предмет (нельзя ремонтировать), с гнездами (%i) | Эфирный предмет (нельзя ремонтировать), с гнездами (%i) |
| Physical Damage Received Increased by %d%% | Получаемый физический урон уменьшен на %d%% | Получаемый физический урон увеличен на %d%% |
