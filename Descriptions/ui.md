...
| Belt Size: %+d Slots | Размер пояса: %+d | Размер пояса: %+d ячеек |
...
| Press Any Key to Begin | Нажмите любую клавишу, чтобы начать | Нажмите любую клавишу, чтобы начать. Мод локализации от 24.02.2026 |
...
| Current Ladder Season ends on %1/%0/%2. | Текущий сезон закончится %1/%0/%2. | Текущий сезон закончится %0.%1.%2. |
